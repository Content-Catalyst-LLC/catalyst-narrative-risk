(function (root, factory) {
  ...
  const SCHEMA_ID = 'https://sustainablecatalyst.com/schemas/narrative-risk/record/1.9.0';
  const INPUT_SCHEMA_ID = 'https://sustainablecatalyst.com/schemas/narrative-risk/input/1.9.0';
  const LEDGER_SCHEMA_ID = 'https://sustainablecatalyst.com/schemas/narrative-risk/evidence-ledger/1.9.0';
  const NARRATIVE_MAP_SCHEMA_ID = 'https://sustainablecatalyst.com/schemas/narrative-risk/narrative-map/1.9.0';
  ...
  function deriveScoringInputs(primaryClaimId, relationships, evidenceById, sourceById, method, fallback) {
    ...
    return { ledger_applied:true, source_type:sourceType, evidence_strength:strength, source_count:sourceIds.size, basis:'Derived from evidence relationships linked to the primary claim using the embedded v1.9.0 ledger policy.' };
  }
