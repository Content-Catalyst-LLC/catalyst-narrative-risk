...
SECURITY_REPORT_SCHEMA_PATH = ROOT / "schemas" / "narrative_risk_security_report.schema.json"
PRIVACY_POLICY_SCHEMA_PATH = ROOT / "schemas" / "narrative_risk_privacy_policy.schema.json"
RETENTION_ASSESSMENT_SCHEMA_PATH = ROOT / "schemas" / "narrative_risk_retention_assessment.schema.json"
BACKUP_MANIFEST_SCHEMA_PATH = ROOT / "schemas" / "narrative_risk_backup_manifest.schema.json"
...
LEGACY_V190_INPUT_SCHEMA_PATH = ROOT / "schemas" / "archive" / "narrative_risk_input.v1.9.0.schema.json"
LEGACY_V190_LEDGER_SCHEMA_PATH = ROOT / "schemas" / "archive" / "narrative_risk_evidence_ledger.v1.9.0.schema.json"
LEGACY_V190_NARRATIVE_MAP_SCHEMA_PATH = ROOT / "schemas" / "archive" / "narrative_risk_narrative_map.v1.9.0.schema.json"
LEGACY_V190_METHOD_SCHEMA_PATH = ROOT / "schemas" / "archive" / "narrative_risk_method_snapshot.v1.9.0.schema.json"
LEGACY_V190_RECORD_SCHEMA_PATH = ROOT / "schemas" / "archive" / "narrative_risk_record.v1.9.0.schema.json"
