"""Canonical v1.6.0 narrative-risk method, evidence-ledger, and narrative-map engine.
...
SCHEMA_ID = "https://sustainablecatalyst.com/schemas/narrative-risk/record/1.6.0"
INPUT_SCHEMA_ID = "https://sustainablecatalyst.com/schemas/narrative-risk/input/1.6.0"
LEDGER_SCHEMA_ID = "https://sustainablecatalyst.com/schemas/narrative-risk/evidence-ledger/1.6.0"
NARRATIVE_MAP_SCHEMA_ID = "https://sustainablecatalyst.com/schemas/narrative-risk/narrative-map/1.6.0"
...
def build_narrative_risk_record(
    ...
    *,
    ...
    """Build a complete v1.6.0 record with an evidence ledger, narrative map, and method."""
    if not isinstance(payload, Mapping):
        raise NarrativeRiskValidationError("payload must be a JSON object")
    method = deepcopy(dict(method_snapshot)) if method_snapshot is not None else current_method_snapshot()
    validate_method_snapshot(method)
