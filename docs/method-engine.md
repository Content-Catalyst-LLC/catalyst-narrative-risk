...
The transparent heuristic remains a weighted additive method. v1.6.0 adds a versioned ledger policy without changing the boundary between analysis and human judgment.
